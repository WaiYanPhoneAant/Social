				...
				<div class="d-flex flex-center w-lg-50 pt-15 pt-lg-0 px-10">
					...
					<div class="d-flex flex-center flex-lg-start flex-column">
						...
						<a href="../../demo7/dist/index.html" class="mb-7">
							<img alt="Logo" src="{{asset('assets/images/social.png')}}" width="280px" />
						</a>
						<!--end::Logo-->
						<!--begin::Title-->
						<h2 class="text-white fw-normal m-0 ps-5">The Place For Your Entertainment</h2>
						<!--end::Title-->
					</div>
					<!--begin::Aside-->
				</div>
                                ...
                                <div class="d-flex flex-center flex-column-fluid pb-15 pb-lg-20">
                                    ...
                                    <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="row g-3 mb-9">
                                            ...
                                            <div class="col-md-6">
                                                <!--begin::Google link=-->
                                                <a href="{{route('login.github')}}" class="btn btn-flex btn-outline btn-text-gray-700 btn-active-color-primary bg-state-light flex-center text-nowrap w-100">
                                                <img alt="Logo" src="{{asset('assets/media/svg/brand-logos/github-1.svg')}}" class="theme-light-show h-15px me-3" />
                                                <img alt="Logo" src="assets/media/svg/brand-logos/apple-black-dark.svg" class="theme-dark-show h-15px me-3" />Sign in with GitHub</a>
                                                <!--end::Google link=-->
                                            </div>
                                            <!--end::Col-->
                                        </div>
                                        ...
                                        <a href="../../demo7/dist/authentication/layouts/creative/sign-up.html" class="link-primary">Sign up</a></div>
                                        <!--end::Sign up-->
                                    </form>
                                    <!--end::Form-->
                                </div>
